    ...
    <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
      <div className="mx-auto max-w-2xl">
        <button
          ...
          className="mb-6 grid h-10 w-10 place-items-center rounded-xl bg-brand-soft text-brand transition-colors hover:bg-brand hover:text-white"
        >
        ...
        <ul className="mt-5 space-y-3 rounded-2xl border border-line bg-white p-5 shadow-card sm:p-6">
          {bullets.map((b) => (
...
function BackIcon(props: { width?: number; height?: number }) {
  return (
