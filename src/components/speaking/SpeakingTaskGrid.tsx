...
/** The dashed "Add Custom Task" tile — the first cell on every part tab. */
...
export function SpeakingTaskGrid({
  ...
  if (tab === 'mock' && items.length === 0) {
    return (
      <EmptyState
        pose="nap"
        title="No speaking mock published yet"
        hint="Check back soon — full speaking papers are on the way."
      />
    )
  }
